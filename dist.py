...
VERSION = __import__('dxlelasticsearchclient').get_version()
RELEASE_NAME = "dxlelasticsearchclient-python-dist-" + str(VERSION)
...
subprocess.check_call(["sphinx-apidoc",
                       ...
                       os.path.join(DIST_PY_FILE_LOCATION, "dxlelasticsearchclient")])
...
print("\nRemoving dxlelasticsearchclient.egg-info\n")
remove_tree(os.path.join(DIST_PY_FILE_LOCATION, "dxlelasticsearchclient.egg-info"))
